...
const workshopName = 'mongodb-sprout-workshop';
// Change this if hosting outside mongodb-developer
const organizationName = "mongodb-developer";

// Main page config
const title = "MongoDB Sprout: Where Data Meets Spring";
const tagLine = "Integrating MongoDB seamlessly with Spring applications";
...
const utmAdvocateName = `tim.kelly`;
const utmWorkshopName = 'mongodb_sprout_workshop'
