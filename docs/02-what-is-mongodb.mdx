...
If you're new to the document model, check out our series on [data modelling for MongoDB](https://www.mongodb.com/developer/products/mongodb/schema-design-anti-pattern-summary/?utm_campaign=devrel&utm_source=workshop&utm_term=devrel.springio.workshop.java).